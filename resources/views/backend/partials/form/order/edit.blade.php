            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Update Status Pengiriman</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="grid grid-cols-1 gap-5 mt-4 rounded-sm border border-stroke bg-white px-7.5 py-4 shadow-default">
        <div class="grid md:grid-cols-2 gap-5 sm:grid-cols-1">
            ...
            <div>
                ...
                <select id="status" name="status_delivery"
                    ...
                    <option selected>{{ $order->status_delivery }}</option>
                    <option value="dikirim">dikirim</option>
                </select>
            </div>
        </div>
        <button type="submit"
            class="text-white bg-primary hover:bg-secondary font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Update
            Status</button>
    </div>
</form>

    ...
    <div class="grid grid-cols-1 gap-5 mt-4 rounded-sm border border-stroke bg-white px-7.5 py-4 shadow-default">
        <div
            ...
            <div>
                ...
                <input type="text" placeholder="Iphone 15 Pro" name="name"
            ...
            <div>
                ...
                <input type="text" inputmode="numeric" placeholder="15000000" name="price"
                    class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" required/>
            </div>
            <div>
                <label class="mb-3 block text-sm font-medium text-black">
                ...
                <input type="text" inputmode="numeric" placeholder="100" name="stock"
                    class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" required/>
            </div>
            <div>
                <div>
        ...
        <button type="submit" class="text-white bg-primary hover:bg-secondary font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Tambah</button>
    </div>
</form>

<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-primary duration-300 ease-linear dark:bg-primary lg:static lg:translate-x-0 overflow-hidden"
    @click.outside="sidebarToggle = false">
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="{{ route('dashboard') }}">
            <h1 class="text-4xl font-bold text-white">iBux</h1>
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a href="{{ route('products') }}"
                            ...
                            :class="page.includes('products') ? 'bg-secondary' : ''">
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="group relative flex justify-center mt-10 items-center w-[100px] gap-2.5 rounded-[30px] py-2 px-4 font-medium bg-white text-secondary duration-300 ease-in-out hover:text-white hover:bg-secondary">Logout</button>
                        </form>
                    </li>
                </ul>
            </div>

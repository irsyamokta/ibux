<nav class="bg-white border-gray-20 fixed w-full z-20 top-0 start-0">
    <div class="flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex xl:w-1/2 items-center md:gap-2 md:order-2 space-x-1 md:space-x-4 rtl:space-x-reverse">
            ...
            <div class="flex justify-center items-center">
                <a href="/cart">
                    <img class="w-7 md:w-10 me-2 md:me-0" src="{{ asset('assets/icon/icon-cart.png') }}"
                        alt="user cart">
                </a>
            </div>
            <div class="flex justify-center items-center">
                <button type="button" class="flex text-sm rounded-full md:me-0 focus:ring-4 focus:ring-gray-300"
                    ...
                    <img class="w-8 md:w-12" src="{{ asset('assets/icon/user.png') }}" alt="user photo">
                </button>
                <!-- Dropdown menu -->
